        ...
        <form action="" class="w-6/12" @submit.prevent="submit">
            <div class="mb-10">
                ...
                <div class="mb-4">
                    ...
                    border-gray-200 rounded-lg w-full h-10 px-4" :class="{'border-red-500': errors['input.job_title']}" v-model="form.job_title">
                ...
                <div class="mb-4">
                    ...
                    border-gray-200 rounded-lg w-full h-10 px-4" :class="{'border-red-500': errors['input.job_location']}" v-model="form.job_location ">
                ...
                <div class="mb-4">
                    ...
                    border-gray-200 rounded-lg w-full h-10 px-4" :class="{'border-red-500': errors['input.job_link']}" v-model="form.job_link">
                ...
                <div class="mb-4">
                    ...
                    <v-select inputId="tags" label="title" :reduce="tag => tag.id" 
                        :options="tags" multiple class="border-2 border-gray-200 rounded-lg" :class="{'border-red-500': errors['input.tags.connect']}" v-model="form.tags"> </v-select>
                ...
                <div class="mb-4">
                    ...
                    border-gray-200 rounded-lg w-full h-10 px-4" :class="{'border-red-500': errors['input.company_name']}" v-model="form.company_name">
                ...
                <div class="mb-4">
                    ...
                    border-gray-200 rounded-lg w-full h-10 px-4" :class="{'border-red-500': errors['input.company_logo']}" v-model="form.company_logo">
            ...
            <dir class="mb-10">
                ...
                <div class="bg-gray-400 p-6 rounded-lg">
                    ...
                    <div class="mb-4">
                        ...
                        border-gray-200 rounded-lg w-full h-10 px-4" :class="{'border-red-500': errors['input.user.create.email']}" v-model="form.user_email">
                    ...
                    <div class="mb-4">
                        ...
                        border-gray-200 rounded-lg w-full h-10 px-4" :class="{'border-red-500': errors['input.user.create.name']}" v-model="form.user_name">
                    ...
                    <div class="mb-4">
                        ...
                        border-gray-200 rounded-lg w-full h-10 px-4" :class="{'border-red-500': errors['input.user.create.password']}" v-model="form.user_password">
